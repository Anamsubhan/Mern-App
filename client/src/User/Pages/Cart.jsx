        ...
        <div className="container">
            ...
            <div className="p-5 rounded bg-dark">
                    ...
                    cart_state.cart.map((val, key) => <div className="card mb-3 w-100" key={key}>
                        <div className="row g-0">
                            <div className="col-md-2 d-flex justify-content-center align-items-center">
                                <img src={val.thumb} style={{ height: '10vh', objectFit: 'contain' }} className="img-fluid rounded-start" alt={val.productName} />
                            </div>
                            <div className="col-md-8">
                                <div className="card-body">
                                    <h5 className="card-title">{val.title} - {val.price} {val.priceUnit}</h5>
                ...
                <div className="container mt-3">
                    <button className="d-block w-100 btn btn-dark" onClick={checkout}>CheckOut</button>
                </div>
