        ...
        <div className="container">
            <div className="row">
                <div className="col-md-6 p-5">
                    <img src={product.thumb} alt="" srcSet="" className='img-fluid' />
                ...
                <div className="col-md-6 py-5">
                    ...
                    <div className='d-flex justify-content-around align-items-center bg-light py-4 rounded border border-secondary w-50'>
                    ...
                    <div className='d-block mt-3 w-50'><button className="w-100 btn btn-dark" onClick={addtocart}>Add to Cart</button></div>
                </div>
            </div>
        </div>
    )
